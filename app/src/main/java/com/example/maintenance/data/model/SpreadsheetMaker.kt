...
class SpreadsheetMaker {
    ...
    private class PeopleSheetMaker {
        ...
        fun create(title : String, people: List<Menu>) : Sheet {
            val sheet = Sheet()
    ...
    private class GridDataMaker {
        ...
        fun create(people : List<Menu>, startRow : Int, startColumn : Int) : GridData {
            ...
            people.mapTo(listRowData) { rowDataMaker.create(it.nameMenuEng, it.pathImage) }
